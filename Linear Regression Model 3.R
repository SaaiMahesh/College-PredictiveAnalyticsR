...
#We use dummy variables when the DV (dependent variable) is numerical. It has to be converted to categorical for regression (either linear or logistic regression)
