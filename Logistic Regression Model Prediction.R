...
summary(model1) #If p < 0.05, it is significant. 
#AIC - Akaikes's Information Criterion. Lower the AIC, better the model since it means there is lesser variation.
#We can also use AIC() function to determine the AIC.
